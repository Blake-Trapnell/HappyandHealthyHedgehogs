...
export default class Logo extends Component {
    ...
    runningMan() {
        setInterval(()=>console.log("i'm waiting"),2000)
    ...
    render() {
        return(
        <div>
            <img className="logo" src={this.state.runningHH[this.state.index]} alt="hedgehog logo"/>
            {/* {setInterval(() => {
                this.runningMan()
            }, 2000)} */}
        </div>
